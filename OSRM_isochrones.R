...
generate_isochrones_from_points <- function(points_shapefile, # Input: Path to the points shapefile
                                            ...
                                            breaks = seq(0, 10, 5), # Input: Time breaks for isochrones (in minutes) first number is the starting value, second is ending, third is interval. (0,10,5) would produce 2 isochrones of 5 and 10 minutes respectively.
...
points <- "C:/Users/plato/Desktop/Dasymetric_analysis_thesis/clipped_tester/clipped_tester.shp"
output <- "tester_output.shp"
